...
?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Tabel Keputusan</h1>
                        </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                   ...
                                                   $sql ="SELECT * FROM tabel_keputusan";
                                                   $query = mysqli_query($dbcon, $sql);
                                                   $n = 1 ;
                                                   while ($barisketerangan=mysqli_fetch_assoc($query)) {
                                                        
                                                ?>
                                                <tr>
                                                    <td><?=$n?></td>
                                                    <td><?=$barisketerangan['nilai_keputusan']?></td>
                                                    <td class="text-left"><?=$barisketerangan['keterangan']?></td>
