                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading justify-content-center" style="background-color: #fdfdfd;">
                            <h2 class="panel-title text-center">Silahkan User Anda Login Terlebih Dahulu</h2>
                            <img class="" style="margin: 20px 65px;" width="180px" height="200px" src="css/dpmd.png"><br>
                        </div>
                            ...
                            <?php
                                if (isset($_POST['submit'])) {
                                    ...
                                    if (mysqli_num_rows($querylogin) > 0 ) {
                                        ...
                                        $_SESSION['kode_desa'] = $data['kode_desa'];
                                        $_SESSION['level'] = 'user';
                                        $_SESSION['stat'] = 'masuk';
                                        ...
                                        echo "<script>alert('Masukkan Username dan Password Anda”')</script>";
